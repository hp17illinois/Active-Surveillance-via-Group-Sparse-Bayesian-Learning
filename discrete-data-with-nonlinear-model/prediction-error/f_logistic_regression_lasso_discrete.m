function [w_inf_gl,block_ind] = f_logistic_regression_lasso_discrete(y,Phi,budget_k,group_len)
[n,m]=size(Phi);
step_len = 0.01;
banl_beta = 1 * (n/m);
...
for i =1:iter_num
    ...
    A = diag(group_pw);
    updat_w = f_for_up_pd(inf_w,Phi,y,A);
    inf_w_old=inf_w;
    ...
    J = f_group_lasso_discrete_costFunction( inf_w,Phi,y,A );
    i
    J
    if J > J_pre
