function [ est_y,MI_sel_set ] = f_GPMI_method_discrete( trai_x,trai_y,budget_k,test_x )
%%% training
[~, nodeNum] = size(trai_x);
...
est_y = f_GPMI_dynamicsPrediction_discrete(x,Sigma,MI_sel_set,u_set,mean_fun_x,mean_fun_y);
end
