function [ MPME_est_y, MPME_sel_set ] = f_MPME_PCA_method_discrete( trai_x,trai_y,budget_k,test_x )
[~, nodeNum] = size(trai_x);
...
SensorPosition = f_MPME_greed_forb(Phi_frse_k,budget_k,forb_list);
...
MPME_sel_set = sort(SensorPosition');
MPME_est_y = data_prediction_s_p_fra(forb_list,:)';

ind_1 = MPME_est_y > 0.5;
ind_0 = MPME_est_y <= 0.5;
MPME_est_y(ind_1) = 1;
MPME_est_y(ind_0) = 0;
end
