function SensorPosition = f_frame_sense_greed_modified(MeasurementMatrix,sensorNO,forb_list)
%% ********************* Preparation *****************************
...
% SensorPosition = [SensorPosition, Lindex(forb_sen_num+1)];
...
%     SensorPosition = [SensorPosition, Lindex(forb_sen_num+2)];
else
...
for i = sta_idx:N-sensorNO
    ...
    Lindex(i)=maxindex; 
%     SensorPosition = [SensorPosition, Lindex(i)];
