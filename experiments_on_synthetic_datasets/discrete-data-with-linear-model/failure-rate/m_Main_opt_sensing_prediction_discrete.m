...
for i_fold = 1:k_fold
    ...
    [trai_x, trai_y , Wgen] = f_dynamicsGen_compac_discretet(trai_sampleTimeLength, network,periodInterval,BER);
    [test_x, test_y , ~]    = f_dynamicsGen_compac_discretet(test_sampleTimeLength, network,periodInterval,BER);
    ...
    toc
    failure_vector = [failure_rate_MI,failure_rate_SNMA_groupxi,failure_rate_GL,failure_rate_Fs_PCA,failure_rate_MNEP_PCA,failure_rate_MPME_PCA,failure_rate_Fs_GP,failure_rate_MNEP_GP,failure_rate_MPME_GP];
