...
xi = 100*ones(sampleTimeLength*nodeNum,1);
count = 0;
init_flag = 1;
...
while (length(gamma)>sen_k)
    ...
    while (1)
        ...
        [mu_x,mu_x_concise,sigma_x_matrix_concise] = f_variance_aprox(trai_x,trai_y,xi_concise,Sigma0,usedNum,maxLen);
