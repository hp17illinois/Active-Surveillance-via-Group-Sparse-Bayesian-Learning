function [ MPME_GP_est_y, MPME_GP_sel_set ] = f_MPME_GP_method_discrete( trai_x,trai_y,budget_k,test_x )
...
SensorPosition = f_MPME_greed_modified(A,budget_k);
MPME_GP_sel_set = sort(SensorPosition');
...
ind_1 = MPME_GP_est_y > 0.5;
ind_0 = MPME_GP_est_y <= 0.5;
MPME_GP_est_y(ind_1) = 1;
MPME_GP_est_y(ind_0) = 0;
end
