function [ FsPCA_est_y, FsPCA_sel_set ] = f_frame_sense_PCA_method( trai_x,trai_y,budget_k,test_x )
[~, nodeNum] = size(trai_x);
...
% SensorPosition = f_frame_sense_greed_forb(Phi_frse_k,budget_k,forb_list);
