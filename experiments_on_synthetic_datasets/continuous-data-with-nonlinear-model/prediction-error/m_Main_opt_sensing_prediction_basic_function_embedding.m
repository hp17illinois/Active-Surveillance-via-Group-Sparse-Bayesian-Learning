...
k_hub = 20;    %pre-given number of important node
...
[trai_x,trai_x_embd, trai_y , Wgen] = f_dynamicsGen_compact_poly_fun_embd(trai_sampleTimeLength,network,NumBasicFunc,periodInterval); % a simple basic function x^2
[test_x,test_x_embd, test_y , ~] = f_dynamicsGen_compact_poly_fun_embd(test_sampleTimeLength,network,NumBasicFunc,periodInterval);
